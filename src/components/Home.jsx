...
<div className="flex flex-col sm:flex-row justify-between text-center p-6">
  <div className="bg-gray-200 w-full sm:w-1/3 p-4 flex justify-center items-center flex-col">
    <img
      className="rounded-full w-70 h-70 object-cover border-3 border-indigo-500/50 shadow-lg"
      src={personal}
      alt="Profile"
    />
 ...
 <h1 className="mt-10 bg-gray-400 w-70 p-4 rounded-md  m-auto ">Front End </h1>
  <div className="flex gap-20">
 <img
      className="rounded-full w-30 h-30 object-cover mt-10 border-3 border-indigo-500/50 shadow-lg"
      src={html}
      alt="Profile"
    />
    <h1 className="flex justify-center items-center mt-10 ">HTML</h1>
</div>
 <div className="flex sm:gap-20 gap-1">
 <img
      className="rounded-full w-30 h-30 object-cover mt-10 border-3 border-indigo-500/50 shadow-lg "
      src={css}
      alt="Profile"
 ...
 <h1 className="mt-10 bg-gray-400 w-70 p-4 rounded-md  m-auto ">Back End </h1>
